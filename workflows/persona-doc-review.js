...
PERSONA C, outside domain contributor. You want to add ONE new skill and ONE knowledge concept to a plugin. Your journey: (1) marketplace/CONTRIBUTING.md, (2) plugin-template/README.md and knowledge-template/README.md, (3) the contributor guides in marketplace/docs/ (contributing-a-skill, contributing-knowledge, knowledge-vs-skills, testing, package-authoring-guide), (4) the issue templates in .github. Judge: is each instruction actionable for someone who was NOT part of the build? Flag any stale instruction (e.g. text saying guides don't exist yet when they do), any guide that name-drops a build episode ("the MHT basin-scope correction", "check 11", "PARKING #7") without teaching the lesson inline, and any reference you cannot resolve from public files. A stale or unresolvable instruction that would misdirect you is a blocker.`,
  },
  {
    key: 'steward',
    prompt: `${COMMON}
